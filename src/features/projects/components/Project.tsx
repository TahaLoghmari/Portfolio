...
import SmartPly from "../../../shared/assets/SmartPly.png";
...
export default function Project({ info }: { info: projectInfo }) {
  ...
  return (
    <a
      className="flex h-110 flex-col overflow-hidden rounded-lg border"
      href={info.liveDemo || "#"}
      target="_blank"
      rel="noopener noreferrer"
    >
      <div className="h-45 w-full border-b">
        <img
          src={imageSrc}
          alt={info.title}
      ...
      <div className="flex flex-1 flex-col justify-between p-3">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2">
            {info.liveDemo && (
              <a
                className="text-primary flex cursor-pointer items-center gap-1 rounded-sm border p-1"
                target="_blank"
                rel="noopener noreferrer"
                href={info.liveDemo}
              >
                ...
                {!(currentScreenSize >= 1280 && currentScreenSize <= 1298) &&
                  !(currentScreenSize >= 1024 && currentScreenSize <= 1060) && (
            ...
            {info.videoDemo && (
              <a
                ...
                href={info.videoDemo}
              >
                <Video className="h-4 w-4 cursor-pointer font-light" />
                {!(currentScreenSize >= 1280 && currentScreenSize <= 1298) &&
                  !(currentScreenSize >= 1024 && currentScreenSize <= 1060) && (
                    <p className="text-xs font-medium">Video Demo</p>
                  )}
              </a>
            )}
            <a
